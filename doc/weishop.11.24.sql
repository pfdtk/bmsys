...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='权限表_by_jiang';

-- ----------------------------
-- Records of bk_access
-- ----------------------------
INSERT INTO `bk_access` VALUES ('12', '3', '1', '2');
INSERT INTO `bk_access` VALUES ('13', '3', '4', '2');
INSERT INTO `bk_access` VALUES ('14', '3', '20', '2');
INSERT INTO `bk_access` VALUES ('15', '3', '27', '2');
INSERT INTO `bk_access` VALUES ('16', '3', '28', '2');
INSERT INTO `bk_access` VALUES ('17', '3', '29', '2');
INSERT INTO `bk_access` VALUES ('18', '3', '43', '2');
INSERT INTO `bk_access` VALUES ('19', '3', '53', '2');
INSERT INTO `bk_access` VALUES ('20', '3', '66', '2');
INSERT INTO `bk_access` VALUES ('21', '3', '44', '2');
INSERT INTO `bk_access` VALUES ('22', '3', '74', '2');
INSERT INTO `bk_access` VALUES ('23', '3', '75', '2');
INSERT INTO `bk_access` VALUES ('24', '3', '76', '2');
...
INSERT INTO `bk_group` VALUES ('4', 'asdf', '123', '1', '123');
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='权限节点表_by_jiang';
...
INSERT INTO `bk_permission` VALUES ('75', 'foundation', 'upload', 'process', '弹窗上传处理', '0', '66', '0', '2', '', '1448029789');
...
CREATE TABLE `bk_product_attrname` (
  `attrname_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bk_product_attrvalue` (
  `attrvalue_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bk_product_attr_relation` (
  `p_attr_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bk_product_category_attrname` (
  `c_attr_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Records of bk_users
-- ----------------------------
INSERT INTO `bk_users` VALUES ('1', 'admin', 'c4ca4238a0b923820dcc509a6f75849b', '1', '管理员', 'oyzzO7YxmgJHlAfdK5HaZMscegJPcTrw5drPQRS6bjlfAkTB6NELPvqpc12q', '0', '0', '12', '1', '超级用户组', '127.0.0.1', '1448367024');
INSERT INTO `bk_users` VALUES ('3', 'test', 'c4ca4238a0b923820dcc509a6f75849b', '4', 'sdf', '', '1448340510', '0', '23123123', '1', 'sdfsdf', '127.0.0.1', '1448342468');
...
INSERT INTO `bk_workflow_user` VALUES ('34', '15', '3', '10');
INSERT INTO `bk_workflow_user` VALUES ('35', '15', '1', '10');
