...
INSERT INTO `bk_action_log` VALUES ('816', 'admin', '1', '127.0.0.1', '', '1448863334', '管理员', '登录系统成功');
INSERT INTO `bk_action_log` VALUES ('817', 'admin', '1', '127.0.0.1', '', '1448865292', '管理员', '登录系统成功');
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 COMMENT='权限节点表_by_jiang';

-- ----------------------------
-- Records of bk_permission
-- ----------------------------
INSERT INTO `bk_permission` VALUES ('1', 'foundation', '系统管理', '系统管理', '系统管理', '1', '0', '0', '系统管理页面，不作权限验证，只用做菜单显示', '0');
INSERT INTO `bk_permission` VALUES ('2', 'foundation', 'group', 'index', '用户组管理', '1', '1', '2', '用户组管理页面', '0');
INSERT INTO `bk_permission` VALUES ('3', 'foundation', 'acl', 'index', '功能管理', '1', '1', '1', '功能管理页面', '0');
INSERT INTO `bk_permission` VALUES ('4', 'foundation', 'user', 'index', '用户管理', '1', '1', '3', '用户管理页面', '0');
INSERT INTO `bk_permission` VALUES ('20', 'foundation', 'user', 'add', '增加用户', '0', '4', '0', '增加一个用户', '0');
INSERT INTO `bk_permission` VALUES ('23', 'foundation', 'group', 'add', '增加用户组', '0', '2', '0', '增加用户组', '1406882443');
INSERT INTO `bk_permission` VALUES ('24', 'foundation', 'group', 'edit', '用户组编辑', '0', '2', '0', '用户组编辑', '1406882515');
INSERT INTO `bk_permission` VALUES ('25', 'foundation', 'group', 'delete', '用户组删除', '0', '2', '0', '用户组删除、批量删除', '1406882542');
INSERT INTO `bk_permission` VALUES ('26', 'foundation', 'acl', 'group', '用户组权限管理', '0', '2', '0', '用户组权限管理', '1406882568');
INSERT INTO `bk_permission` VALUES ('27', 'foundation', 'user', 'edit', '用户编辑', '0', '4', '0', '用户编辑', '1406882640');
INSERT INTO `bk_permission` VALUES ('28', 'foundation', 'user', 'delete', '用户删除', '0', '4', '0', '用户删除', '1406882664');
INSERT INTO `bk_permission` VALUES ('29', 'foundation', 'acl', 'user', '用户权限管理', '0', '4', '0', '用户权限管理、设置用户权限', '1406882698');
INSERT INTO `bk_permission` VALUES ('30', 'foundation', 'acl', 'add', '增加功能菜单', '0', '3', '0', '增加功能菜单', '1406882729');
INSERT INTO `bk_permission` VALUES ('31', 'foundation', 'acl', 'edit', '功能菜单编辑', '0', '3', '0', '功能菜单编辑', '1406882754');
INSERT INTO `bk_permission` VALUES ('32', 'foundation', 'acl', 'delete', '功能菜单删除', '0', '3', '0', '功能菜单删除', '1406882775');
INSERT INTO `bk_permission` VALUES ('33', 'foundation', 'acl', 'sort', '功能菜单排序', '0', '3', '0', '功能菜单排序', '1406882815');
INSERT INTO `bk_permission` VALUES ('43', 'foundation', 'index', 'cs', '功能示例', '1', '1', '0', '一些小功能的合集，可以用来加快开发的速度。', '1427788812');
INSERT INTO `bk_permission` VALUES ('44', 'foundation', 'upload', 'index', '弹出窗口上传', '0', '66', '0', '通用的弹出窗口上传。', '1427790345');
INSERT INTO `bk_permission` VALUES ('53', 'foundation', 'log', 'action', '操作日志', '1', '78', '0', '查看操作日志', '1433319136');
INSERT INTO `bk_permission` VALUES ('55', '工作流管理', '工作流管理', '工作流管理', '工作流管理', '1', '0', '0', '', '1434093108');
INSERT INTO `bk_permission` VALUES ('56', 'workflow', 'index', 'add', '工作流增加', '0', '73', '0', '增加新的工作流程', '1434333268');
INSERT INTO `bk_permission` VALUES ('57', 'workflow', 'index', 'edit', '工作流编辑', '0', '73', '0', '修改工作流信息', '1434336714');
INSERT INTO `bk_permission` VALUES ('58', 'workflow', 'index', 'delete', '工作流删除', '0', '73', '0', '删除工作流', '1434338279');
INSERT INTO `bk_permission` VALUES ('59', 'workflow', 'step', 'index', '工作流详情', '0', '55', '1', '查看工作流详情', '1434345119');
INSERT INTO `bk_permission` VALUES ('60', 'workflow', 'step', 'add', '增加工作流步骤', '0', '59', '0', '增加工作流步骤', '1434349481');
INSERT INTO `bk_permission` VALUES ('61', 'workflow', 'step', 'edit', '编辑工作流步骤', '0', '59', '0', '编辑工作流步骤', '1434353110');
INSERT INTO `bk_permission` VALUES ('62', 'workflow', 'step', 'delete', '工作流步骤删除', '0', '59', '0', '工作流步骤删除', '1434354926');
INSERT INTO `bk_permission` VALUES ('63', 'workflow', 'step', 'relation', '工作流设置关联人员', '0', '59', '0', '工作流设置关联人员', '1434422499');
INSERT INTO `bk_permission` VALUES ('66', '通用功能', '通用功能', '通用功能', '通用功能', '0', '0', '0', '通用功能，一般会开发这些功能给用户。', '1435545336');
INSERT INTO `bk_permission` VALUES ('73', 'workflow', 'index', 'index', '工作流列表', '1', '55', '2', '', '1436232634');
INSERT INTO `bk_permission` VALUES ('74', 'foundation', 'index', 'index', '默认首页', '0', '66', '0', '', '0');
INSERT INTO `bk_permission` VALUES ('75', 'foundation', 'upload', 'process', '弹窗上传处理', '0', '44', '0', '', '1448029789');
INSERT INTO `bk_permission` VALUES ('76', 'foundation', 'user', 'mpassword', '修改个人登陆密码', '0', '66', '0', '', '1448031475');
INSERT INTO `bk_permission` VALUES ('78', '系统日志', '系统日志', '系统日志', '系统日志', '1', '0', '0', '', '1448342575');
INSERT INTO `bk_permission` VALUES ('79', '店铺配置', '店铺配置', '店铺配置', '店铺配置（重要）', '1', '0', '0', '', '1448446537');
INSERT INTO `bk_permission` VALUES ('80', 'product', 'index', 'index', '商品管理', '1', '86', '0', '商品管理列表', '1448446686');
INSERT INTO `bk_permission` VALUES ('81', 'foundation', 'upload', 'imagelist', '弹窗上传图库', '0', '44', '0', '', '1448518776');
INSERT INTO `bk_permission` VALUES ('82', 'shop', 'category', 'index', '核心分类管理', '1', '79', '0', '', '1448632405');
INSERT INTO `bk_permission` VALUES ('83', 'shop', 'brand', 'index', '品牌管理', '1', '79', '0', '', '1448632513');
INSERT INTO `bk_permission` VALUES ('84', 'shop', 'series', 'index', '系列管理', '1', '79', '0', '', '1448632734');
INSERT INTO `bk_permission` VALUES ('85', 'shop', 'attribute', 'index', '属性管理', '1', '79', '0', '', '1448632776');
INSERT INTO `bk_permission` VALUES ('86', '商品管理', '商品管理', '商品管理', '商品管理', '1', '0', '0', '', '1448635615');
INSERT INTO `bk_permission` VALUES ('87', 'product', 'category', 'index', '自定义分类管理', '1', '86', '0', '', '1448635925');
INSERT INTO `bk_permission` VALUES ('88', '报表管理', '报表管理', '报表管理', '报表管理', '1', '0', '0', '', '1448636071');
INSERT INTO `bk_permission` VALUES ('89', '测试报表', '测试报表', '测试报表', '测试报表', '1', '88', '0', '', '1448636103');
INSERT INTO `bk_permission` VALUES ('90', 'product', 'trash', 'index', '回收站', '1', '86', '0', '', '1448636214');
INSERT INTO `bk_permission` VALUES ('91', 'shop', 'category', 'add', '添加核心分类', '0', '82', '0', '', '1448685116');
INSERT INTO `bk_permission` VALUES ('92', 'shop', 'category', 'sort', '核心分类排序', '0', '82', '0', '', '1448692183');
INSERT INTO `bk_permission` VALUES ('93', 'shop', 'category', 'edit', '核心分类编辑', '0', '82', '0', '', '1448693249');
INSERT INTO `bk_permission` VALUES ('94', 'shop', 'category', 'delete', '核心分类删除', '0', '82', '0', '', '1448693270');
...
-- ----------------------------
INSERT INTO `bk_product_category` VALUES ('1', '服饰鞋帽', '0', '1', '1448691201', '1448858323', '1');
INSERT INTO `bk_product_category` VALUES ('2', '礼品箱包', '0', '1', '1448691494', '1448858333', '1');
INSERT INTO `bk_product_category` VALUES ('3', '家居家装', '0', '1', '1448691508', '1448858336', '1');
INSERT INTO `bk_product_category` VALUES ('4', '女装', '1', '2', '1448693608', '1448859932', '1');
INSERT INTO `bk_product_category` VALUES ('5', '男装', '1', '3', '1448694668', '1448858325', '1');
...
-- Records of bk_users
-- ----------------------------
INSERT INTO `bk_users` VALUES ('1', 'admin', 'c4ca4238a0b923820dcc509a6f75849b', '1', '管理员', 'oyzzO7YxmgJHlAfdK5HaZMscegJPcTrw5drPQRS6bjlfAkTB6NELPvqpc12q', '0', '0', '12', '1', '超级用户组', '127.0.0.1', '1448865292');
