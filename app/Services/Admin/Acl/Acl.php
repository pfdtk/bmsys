...
class Acl
{
    ...
    public function checkIfHasPermission($module, $class, $function)
    {
        ...
        foreach($permissionList as $value) {
            if($this->matchAction($value, $module, $class, $function)) return true;
        }
     ...
     * match action
     */
    private function matchAction($permission, $module, $class, $function)
    {
        if($permission['module'] == $module && $permission['class'] == $class && $permission['action'] == $function) return true;
        return false;
    }
