...
) ENGINE=InnoDB AUTO_INCREMENT=541 DEFAULT CHARSET=utf8 COMMENT='权限表_by_jiang';
...
INSERT INTO `bk_access` VALUES ('531', '3', '1', '2');
INSERT INTO `bk_access` VALUES ('532', '3', '4', '2');
INSERT INTO `bk_access` VALUES ('533', '3', '20', '2');
INSERT INTO `bk_access` VALUES ('534', '3', '27', '2');
INSERT INTO `bk_access` VALUES ('535', '5', '1', '1');
INSERT INTO `bk_access` VALUES ('536', '5', '4', '1');
INSERT INTO `bk_access` VALUES ('537', '5', '29', '1');
INSERT INTO `bk_access` VALUES ('538', '4', '1', '1');
INSERT INTO `bk_access` VALUES ('539', '4', '2', '1');
INSERT INTO `bk_access` VALUES ('540', '4', '23', '1');
...
CREATE TABLE `bk_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='用户组表_by_jiang';
...
INSERT INTO `bk_group` VALUES ('3', '柘城', '可耕地', '1', '1');
INSERT INTO `bk_group` VALUES ('4', '柘城', '可耕地', '1', '1');
INSERT INTO `bk_group` VALUES ('5', '柘城', '可耕地', '1', '1');
...
INSERT INTO `bk_permission` VALUES ('53', 'foundation', 'log', 'action', '操作日志', '1', '1', '0', '3', '查看操作日志', '1433319136');
INSERT INTO `bk_permission` VALUES ('55', '工作流管理', '工作流管理', '工作流管理', '工作流管理', '1', '0', '0', '2', '', '1434093108');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='用户表_by_jiang';

-- ----------------------------
-- Records of bk_users
-- ----------------------------
INSERT INTO `bk_users` VALUES ('1', 'admin', '6512bd43d9caa6e02c990b0a82652dca', '1', '管理员', 'oyzzO7YxmgJHlAfdK5HaZMscegJPcTrw5drPQRS6bjlfAkTB6NELPvqpc12q', '0', '0', '12', '1', '超级用户组', '127.0.0.1', '1447914894');
INSERT INTO `bk_users` VALUES ('3', 'funny', '6a9edcb7b63821802aa44d35d531c9fc', '2', '天天向上', '', '1447907167', '0', '12345678971', '1', '', '', '0');
