<div class="modify-password-content" style="display:none;">
  <div class="form-group  input-group-sm">
    <label>旧密码</label>
    <input type="password" value="" name="old_password" class="span4">
  </div>
  <div class="form-group  input-group-sm">
    <label>新密码</label>
    <input type="password" value="" name="new_password" class="span4">
  </div>
  <div class="form-group  input-group-sm">
    <label>确认新密码</label>
    <input type="password" value="" name="new_password_repeat" class="span4">
  </div>
</div>
<script type="text/javascript">
  var __mpass = {
    postUrl: '<?php echo route('foundation.user.mpassword'); ?>',
